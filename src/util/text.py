...
score_font = pygame.font.Font('src/util/pricedown bl.ttf', 30)
font = pygame.font.Font('src/util/pricedown bl.ttf', 14)
press = pygame.font.Font('src/util/pricedown bl.ttf', 45)
